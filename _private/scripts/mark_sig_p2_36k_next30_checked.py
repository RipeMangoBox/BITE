#!/usr/bin/env python3
"""Mark verified SIGGRAPH P2/36K next30 successes as checked."""
...
RESULTS = [
    Path("obsidian-vault/batches/sig_p2_36k_next30_20260627/run/results.jsonl"),
    Path("obsidian-vault/batches/sig_p2_36k_next30_topup_20260627/run/results.jsonl"),
]
PAPER_LIST = Path("obsidian-vault/paper_list.csv")


def success_pdfs() -> set[str]:
    pdfs: set[str] = set()
    for path in RESULTS:
