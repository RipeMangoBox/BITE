...
Usage:
  ...
  cd <repo_root>
  python3 _private/scripts/batch_analyze_api_claude.py [--batch-size 8] [--max-papers 100]
"""
...
# ── Config ────────────────────────────────────────────────────────
DEFAULT_LOG = "paperAnalysis/processing/github_awesome/bradyfu__awesome-multimodal-large-language-models/analysis_log.csv"
BATCH_SIZE = 4
