...
def main() -> None:
    ...
    sampler = {
        ...
        "cfg_mode": "bilateral_textspace_3pass" if (args.cfg_human is not None and args.cfg_camera is not None) else ("standard_single_cfg" if args.cfg_scale != 1.0 else "conditional_only"),
