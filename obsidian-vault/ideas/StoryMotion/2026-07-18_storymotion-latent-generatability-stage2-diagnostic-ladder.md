...
5. 用户已授权 C3-25 seed17 的连续 Stage2 `105K` 非晋级诊断；D1 与 `10K` first-64 three-profile health slice 已闭合，4090 GPU0 继续长训，4090 GPU1 保留给 immutable 30K full eval，评测不阻断主训练。
