...
status: historical/partially-valid
tags:
  - StoryMotion
  - Motion_Generation
  - experiment
...
> [!danger] Partially invalidated historical ledger
> 本页的 official-Pulp-cache v6 rows、official Pulp anchors与P2a/P2b reliability结果仍可保留；local tokenizer Stage1/Stage2 rows及其visualization受后续 feature/decode/cache contract纠错影响，不能用于正式排名或demanifold定年。当前唯一canonical台账见 [[2026-07-12_storymotion-valid-metric-ledger]]。
