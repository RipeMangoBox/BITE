...
- n/evaluable: `4/4 text rows; 0 generator traces`
...
|---|---:|---|---|---:|---|
| mogents | 1 | p1evt_2_walk_turn__event_01 | locomotion_path | 0.9689 | 缺失 |
| momask | 1 | p1evt_2_walk_turn__event_01 | locomotion_path | 0.9689 | 缺失 |
| mogents | 2 | p1evt_2_walk_turn__event_02 | direction_change | 0.9427 | 缺失 |
| momask | 2 | p1evt_2_walk_turn__event_02 | direction_change | 0.9427 | 缺失 |
