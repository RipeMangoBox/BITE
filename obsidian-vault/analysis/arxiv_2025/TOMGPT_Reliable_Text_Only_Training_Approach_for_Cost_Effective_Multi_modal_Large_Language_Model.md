...
![[assets/figures/papers/paper_list_l13_https_arxiv_org_abs_2505_05606/figures/004_Figure_4.jpg]]
*Figure 4: In-context prompt example. ChatGPT can generate a fourth sentence based on any three seed sentences. These four sentences can be randomly selected to form a new prompt, thereby iteratively generating a significant amount of text. The content highlighted in red is generated by OpenAI GPT-3.5 Turbo API [31]*
...
![[assets/figures/papers/paper_list_l13_https_arxiv_org_abs_2505_05606/figures/001_Figure_1.jpg]]
*Figure 1: Illustration of our model trained solely on text data. Unlike previous MLLMs, our model does not require image data during training, greatly reducing the data and time costs*
...
![[assets/figures/papers/paper_list_l13_https_arxiv_org_abs_2505_05606/figures/012_Table_5.jpg]]
*Table 5: Ablation Study on the use of Pre-training Data The experiments revealed that each method of data acquisition possesses its own strengths and weaknesses. The combination of both datasets can enhance the model’s performance further*
