...
![[assets/figures/papers/paper_list_l2509_https_openaccess_thecvf_com_content_CVPR2026_html_Sun_GeoRK2_Geometry_Gu/figures/001_Figure_1.jpg]]
*Figure 1: (a) GeoRK2 respects the intrinsic manifold geometry, producing smoother and more faithful feature trajectories than Euclidean-space prediction methods that ignore curvature. (b) Under large step sizes, GeoRK2 remains stable, while geometryagnostic predictors suffer from rapidly accumulated errors*

![[assets/figures/papers/paper_list_l2509_https_openaccess_thecvf_com_content_CVPR2026_html_Sun_GeoRK2_Geometry_Gu/figures/003_Figure_3.jpg]]
*Figure 3: Variance Explained by Leading Directions. Heatmaps for (a) DiT-XL/2 and (b) FLUX.1-dev showing that the top-64 principal directions account for over 99%*
...
![[assets/figures/papers/paper_list_l2509_https_openaccess_thecvf_com_content_CVPR2026_html_Sun_GeoRK2_Geometry_Gu/figures/008_Figure_5.jpg]]
*Figure 5: Effect of truncation rank on feature reconstruction. Scatter plots comparing original and low-rank features at ratios 1/64, 1/32, 1/16, 1/8 show tighter identity alignment at higher ranks, plateauing at 1/64–1/32—consistent with FID saturation and ≥99% spectral energy capture*
