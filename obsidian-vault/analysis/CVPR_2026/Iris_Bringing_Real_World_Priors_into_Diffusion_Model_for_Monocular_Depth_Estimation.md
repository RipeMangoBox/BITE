...
![[assets/figures/papers/paper_list_l2525_https_arxiv_org_abs_2603_16340/figures/006_Table_1.jpg]]
*Table 1: Quantitative comparison on zero-shot affine-invariant depth estimation. The upper section lists conventional discriminative methods, and the lower section lists diffusion-based methods. The best performances are bolded. All Avg Ranking averages the permetric ranks over all methods, while Group Avg Ranking averages ranks computed within each section. ⋆ denotes methods relying on pre-trained Stable Diffusion [30]. Note that Iris is trained on 59K synthetic images and 100K real images with pseudo labels generated by DAv2 [46].Compared with deterministic feed-forward models trained on massive real-image corpora (e.g., the DA [45, 46] family), Iris retains a clear advantage in training data effi...*

![[assets/figures/papers/paper_list_l2525_https_arxiv_org_abs_2603_16340/figures/009_Table_3.jpg]]
*Table 3: Ablation studies of essential components. Deterministic alone refers to single-step deterministic network. Deterministic + SGD stands for simultaneous supervision on synthetic ground truth and real pseudo labels after single-stage. Note that two-stage denotes Priors-to-Geometry pipeline. Collectively, Deterministic + two-stage + SGD + SGC define our final Priors-to-Geometry Deterministic (PGD) framework. See §4.4 for details*

![[assets/figures/papers/paper_list_l2525_https_arxiv_org_abs_2603_16340/figures/008_Figure_7.jpg]]
...
![[assets/figures/papers/paper_list_l2525_https_arxiv_org_abs_2603_16340/figures/007_Figure_6.jpg]]
*Figure 6: Qualitative comparison on diverse scenes. Iris demonstrates consistent cross-scene generalization and accurate fine-detail modeling. See §4.3 for details. For more qualitative results, please refer to the supplementary material*

![[assets/figures/papers/paper_list_l2525_https_arxiv_org_abs_2603_16340/figures/011_Table_2.jpg]]
*Table 2: Inference efficiency comparison. Inference time (seconds) measured at 15362 resolution on a NVIDIA A100 GPU*
