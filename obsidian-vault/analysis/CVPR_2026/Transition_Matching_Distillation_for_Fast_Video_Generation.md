...
![[assets/figures/papers/paper_list_l946_https_arxiv_org_abs_2601_09881/figures/003_Table_1.jpg]]
...
![[assets/figures/papers/paper_list_l946_https_arxiv_org_abs_2601_09881/figures/004_Table_2.jpg]]
...
![[assets/figures/papers/paper_list_l946_https_arxiv_org_abs_2601_09881/figures/018_Figure_10.jpg]]
*Figure 10: | Effect of KD initialization. We compare the two-step DMD2 results of distilling Wan2.1 1.3B in two settings: (a) with and (b) without KD warm-up, where (left) “Iteration*

#### TM-MF 预训练

Table 6 对比了第一阶段预训练方法。TM-MF（基于 MeanFlow 目标）比直接使用普通流匹配（TM）能取得更好的最终蒸馏性能，验证了 MeanFlow 损失在预训练流头中的有效性。

![[assets/figures/papers/paper_list_l946_https_arxiv_org_abs_2601_09881/figures/013_Table_6.jpg]]
*Table 6: | Impact of the first stage pretraining method on the final performance when we distill Wan2.1 1.3B with ?? = 2*
...
![[assets/figures/papers/paper_list_l946_https_arxiv_org_abs_2601_09881/figures/011_Figure_6.jpg]]
*Figure 6: | Performance-efficiency tradeoff of TMD. We compare the overall VBench score and effective NFE of TMD, when distilling Wan2.1 1.3B with ?? = 2 for different number of inner steps ?? and flow head layers ?? against 2- and 3-step DMD2-v. TMD can provide consistent performance gains for increasing NFE*

![[assets/figures/papers/paper_list_l946_https_arxiv_org_abs_2601_09881/figures/019_Figure_11.jpg]]
*Figure 11: | Performance-efficiency tradeoff of TMD. Extension of Figure 6 to include the ?? = 1 settings*
