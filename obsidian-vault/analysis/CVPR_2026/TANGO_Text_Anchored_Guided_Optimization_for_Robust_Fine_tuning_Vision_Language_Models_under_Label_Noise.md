...
![[assets/figures/papers/paper_list_l786_https_openaccess_thecvf_com_content_CVPR2026_html_Ma_TANGO_Text_Anchored/figures/010_Table_7.jpg]]
*Table 7: Stress Test on CIFAR-100N*

### 超参数敏感性

Figure 2 的敏感性分析显示，每类锚点数量 $K \geq 10$ 时性能即趋于稳定，语义一致性权重 $\beta$ 在 0.3 至 0.7 的宽泛范围内均保持鲁棒。这表明方法对超参数选择不敏感，无需针对不同数据集精细调参。

![[assets/figures/papers/paper_list_l786_https_openaccess_thecvf_com_content_CVPR2026_html_Ma_TANGO_Text_Anchored/figures/005_Figure_2.jpg]]
*Figure 2: Sensitivity analysis of TANGO on CIFAR-100N with respect to the number of anchors per class (K) and the semantic consistency weight (β). Performance stabilizes for*
...
![[assets/figures/papers/paper_list_l786_https_openaccess_thecvf_com_content_CVPR2026_html_Ma_TANGO_Text_Anchored/figures/008_Table_5.jpg]]
*Table 5: Performance comparison on CIFAR-100N across alternative VLM backbones*
...
![[assets/figures/papers/paper_list_l786_https_openaccess_thecvf_com_content_CVPR2026_html_Ma_TANGO_Text_Anchored/figures/009_Table_6.jpg]]
*Table 6: Test accuracy (%) on DTD under synthetic noise*
