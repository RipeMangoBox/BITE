...
![[assets/figures/papers/paper_list_l2223_https_openaccess_thecvf_com_content_CVPR2026_html_Cao_PureProof_Diffusio/figures/001_Figure_1.jpg]]
*Figure 1: Robustness of PureProof against diffusion-based purification (DBP) defenses. DBP’s forward diffusion and reverse denoising process restore adversarial examples generated by existing attacks, leading to original benign outputs. In contrast, PureProof generates adversarial images resistant to purification, successfully inducing outputs aligned with the target text “A red car travels along a mountain highway passing a road sign.”*
...
![[assets/figures/papers/paper_list_l2223_https_openaccess_thecvf_com_content_CVPR2026_html_Cao_PureProof_Diffusio/figures/008_Table_4.jpg]]
*Table 4: Attack performance comparison without defense. We report Ensemble CLIP score (↑). The gray shading highlights our proposed method, while the bold numbers indicate the best results. Qwen3 denotes Qwen3-VL. Gemini denotes Gemini-2.5*
