...
![[assets/figures/papers/paper_list_l5_https_arxiv_org_abs_2403_00691/figures/003_Table_1.jpg]]
*Table 1: Text-to-motion Retrieval on HumanML3D. Presented here are our results on the text-to-motion retrieval tasks conducted on the HumanML3D dataset. The results indicate that our 3-modal version exceeds the performance of Guo et al. [13], TEMOS [30], MotionCLIP [45] and TMR [31]. Moreover, our 3-modal version outperforms our 2-modal version, showing that an extra modality can indeed enhance the alignment between texts and motions. The most notable results are emphasized in bold*
