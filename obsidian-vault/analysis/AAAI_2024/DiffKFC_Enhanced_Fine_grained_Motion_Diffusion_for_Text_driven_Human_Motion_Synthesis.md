...
![[assets/figures/papers/paper_list_l1816_DiffKFC_Enhanced_Fine_grained_Motion_Diffusion_for_Text_driven_Human_Mot/figures/010_Figure_6.jpg]]
*Figure 6: True description: “A person walks forward and waves his left hand.” When spelling waves mistakenly into walks or wavs, MDM fails to extract the information and causes different failures, but our DiffKFC can tolerate both of these errors and produce the desired motion*
