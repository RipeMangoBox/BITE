...
![[assets/figures/papers/paper_list_l1888_HERO_Human_Reaction_Generation_from_Videos/figures/009_Figure_7.jpg]]
*Figure 7: Visualized cases of generating on the Unseen set. Note that the data of the subcategories to which each video in the figure belongs are not utilized when training HERO on the Seen set*

![[assets/figures/papers/paper_list_l1888_HERO_Human_Reaction_Generation_from_Videos/figures/010_Figure_8.jpg]]
*Figure 8: Visualized cases of “walking towards” with different emotions. The left side of each row in the figure is the input video and the right side is the reaction generated by HERO*

![[assets/figures/papers/paper_list_l1888_HERO_Human_Reaction_Generation_from_Videos/figures/014_Table_5.jpg]]
*Table 5: Evaluation results on “walking towards” with different emotions. R. means real motions*

![[assets/figures/papers/paper_list_l1888_HERO_Human_Reaction_Generation_from_Videos/figures/015_Table_6.jpg]]
*Table 6: Quantitative evaluation on the Unseen set*

![[assets/figures/papers/paper_list_l1888_HERO_Human_Reaction_Generation_from_Videos/figures/016_Table_4.jpg]]
*Table 4: Evaluation results on different broad categories of interactions. R. means real motions*

![[assets/figures/papers/paper_list_l1888_HERO_Human_Reaction_Generation_from_Videos/figures/017_Table_7.jpg]]
*Table 7: Evaluation results on different number of training pairs. T.P. means training pairs*
