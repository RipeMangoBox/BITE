...
![[assets/figures/papers/paper_list_l1767_Being_M0_5_A_Real_Time_Controllable_Vision_Language_Motion_Model/figures/002_Figure_2.jpg]]
*Figure 2: Model Illustration. Being-M0.5 supports multi-modal inputs/outputs, built on a 7B LLM backbone. It employs SigLIP+2MLP for visual encoding and projection with a slow-fast strategy, alongside part-aware residual quantization for motion tokenization*
...
![[assets/figures/papers/paper_list_l1767_Being_M0_5_A_Real_Time_Controllable_Vision_Language_Motion_Model/figures/013_Table_8.jpg]]
*Table 8: Evaluation of multi-task motion training effectiveness on the HuMo-T2M testbed across different configurations*

![[assets/figures/papers/paper_list_l1767_Being_M0_5_A_Real_Time_Controllable_Vision_Language_Motion_Model/figures/006_Table_2.jpg]]
*Table 2: Comparison with prior motion generation methods on the Image-to-Motion (I2M) task using the HuMo-I2M testbed. Note that this evaluation is restricted to approaches with publicly available training code*

![[assets/figures/papers/paper_list_l1767_Being_M0_5_A_Real_Time_Controllable_Vision_Language_Motion_Model/figures/010_Table_5.jpg]]
*Table 5: Comparison with previous part-specific text-to-motion methods on HumanML3D*
