...
class DomainSourceRegistry(Base):
    ...
    )  # openalex_topic / openalex_source / awesome_repo / semantic_scholar / local_library
    source_ref: Mapped[str] = mapped_column(Text, nullable=False)
    # e.g. "T12345" for OpenAlex topic, repo URL for awesome, folder path for local_library
